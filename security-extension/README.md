...
5. If all of above steps are successful, the bootable image will be available at **/path-to-arm-systemready/security-extension/scripts/output/se_acs_live_image.img**
