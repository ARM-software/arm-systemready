...
do_install(){
    install -d ${D}${bindir}/linux-6.16/bindings
    cp -r ${S}/linux-6.16/Documentation/devicetree/bindings ${D}/${bindir}/linux-6.16/bindings
    dt-mk-schema -j ${D}/${bindir}/linux-6.16/bindings > processed_schema.json
