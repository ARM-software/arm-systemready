...
* Test Suites changes
  ...
  * Checks related to CapsuleNNN, CapsuleMax, CapsuleLast variables added.
    * **Currenly the test parsing is not enabled, as acs plans to observe results of various platforms**
    * The logs are part of fw/capsule_test_results.log
  * Python based test added for EBBR RuntimeDeviceMappingConflict requirement.
    * **Currenly the test parsing is not enabled, as acs plans to observe results of various platforms**
